...
fuz_inp=[500 ship_speed 0 0 0 0 0 0 0 0];% array to be sent to .fis file, first entry is distance, second is speed and rest are input angles for obstacle positions
...
angle=str_angl;%assign the output 